...
int Interp::check_other_codes(block_pointer block)       //!< pointer to a block of RS274/NGC instructions
{
  ...
  if (block->i_flag == ON) {    /* could still be useless if yz_plane arc */
    CHKS(((motion != G_2) && (motion != G_3) && (motion != G_5) && (motion != G_5_1) && (motion != G_6_2) &&
        ...
        _("I word with no G2, G3, G5, G5.1, G6.2, G10, G76, G87 or G43.1 to use it"));
  }
  ...
  if (block->p_flag == ON) {
      CHKS(((block->g_modes[0] != G_10) && (block->g_modes[0] != G_4) && (block->g_modes[13] != G_64) &&
          ...
          (block->user_m != 1) && (block->artek_m != 1) && (block->m_modes[11] != 200) && (block->m_modes[11] != 201) ),
  ...
  if (block->q_number != -1.0) {
      CHKS((motion != G_83) && (motion != G_73) && (motion != G_5) && (block->user_m != 1) && (block->artek_m != 1) && (motion != G_76) &&
          (block->m_modes[5] != 66) && (block->m_modes[5] != 67) && (block->m_modes[5] != 68) && (block->m_modes[11] != 200) &&
          (block->g_modes[0] != G_10) && (block->m_modes[6] != 61) && (block->g_modes[13] != G_64 &&
          (block->m_modes[11] != 201)),
