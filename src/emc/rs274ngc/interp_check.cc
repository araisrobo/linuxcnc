                         ...
                         setup_pointer settings)        //!< pointer to machine settings
{
  ...
  if (mode0 == -1) {
    ...
    CHKS((((block->l_number == 2 || block->l_number == 20) && ((p_int < 0) || (p_int > 9)))), _("P value out of range (0-9) with G10 L2 or L20"));
...
int Interp::check_other_codes(block_pointer block)       //!< pointer to a block of RS274/NGC instructions
{
  ...
  if (block->p_flag) {
      CHKS(((block->g_modes[0] != G_10) && (block->g_modes[0] != G_4) && (block->g_modes[13] != G_64) &&
          ...
          (block->user_m != 1) && (block->artek_m != 1) && (block->m_modes[11] != 200) ),
