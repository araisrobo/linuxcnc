...
int emcFormat(NMLTYPE type, void *buffer, CMS * cms)
{
	...
	((EMC_MOTION_SET_PSO *) buffer)->update(cms);
	break;
    case EMC_MOTION_SET_LEAPFROG_TYPE:
        ((EMC_MOTION_SET_LEAPFROG *) buffer)->update(cms);
        break;
	...
	((EMC_TRAJ_END_OF_PROBE *) buffer)->update(cms);
	break;
	...
	((EMC_TRAJ_SPINDLE_SYNC_MOTION *) buffer)->update(cms);
        break;
...
const char *emc_symbol_lookup(long type)
{
    ...
    case EMC_MOTION_SET_PSO_TYPE:
	return "EMC_MOTION_SET_PSO";
    case EMC_MOTION_SET_LEAPFROG_TYPE:
        return "EMC_MOTION_SET_LEAPFROG";
    case EMC_MOTION_SET_DOUT_TYPE:
    ...
    case EMC_TRAJ_SPINDLE_SYNC_MOTION_TYPE:
	return "EMC_TRAJ_SPINDLE_SYNC_MOTION";
    case EMC_TRAJ_RESUME_TYPE:
...
/*
*	NML/CMS Update function for EMC_TRAJ_END_OF_PROBE
*	Automatically generated by NML CodeGen Java Applet.
*	on Sat Oct 11 13:45:16 UTC 2003
*/
void EMC_TRAJ_END_OF_PROBE::update(CMS * cms)
{
...
/*
 *	NML/CMS Update function for EMC_MOTION_SET_PSO
 *	Automatically generated by NML CodeGen Java Applet.
 *	on Sat Oct 11 13:45:16 UTC 2003
 */
void EMC_MOTION_SET_PSO::update(CMS * cms)
{
    EMC_MOTION_CMD_MSG::update(cms);
    cms->update(enable);
    cms->update(tick);
...
/*
 *      NML/CMS Update function for EMC_MOTION_SET_LEAPFROG
 *      Automatically generated by NML CodeGen Java Applet.
 *      on Sat Oct 11 13:45:16 UTC 2003
 */
void EMC_MOTION_SET_LEAPFROG::update(CMS * cms)
{
    EMC_MOTION_CMD_MSG::update(cms);
    cms->update(enable);
    cms->update(height);
...
/*
*	NML/CMS Update function for EMC_TRAJ_SPINDLE_SYNC_MOTION
*	Manually generated by Alex Joni.
*	on Sun Mar 04 18:15:17 EET 2007
*/
void EMC_TRAJ_SPINDLE_SYNC_MOTION::update(CMS * cms)
{
