...
# disable hotkeys: root_window.bind("<KeyPress-KP_Begin>", kp_wrap(lambda e: None, "KeyPress"))
# disable hotkeys: root_window.bind("<KeyPress-KP_Insert>", kp_wrap(lambda e: None, "KeyPress"))

# disable hotkeys: if lathe:
# disable hotkeys:     bind_axis("Left", "Right", 2)
# disable hotkeys:     bind_axis("Up", "Down", 0)
# disable hotkeys:     bind_axis("KP_Left", "KP_Right", 2)
# disable hotkeys:     bind_axis("KP_Up", "KP_Down", 0)
# disable hotkeys:     root_window.bind("<KeyPress-KP_Next>", kp_wrap(lambda e: None, "KeyPress"))
# disable hotkeys:     root_window.bind("<KeyPress-KP_Prior>", kp_wrap(lambda e: None, "KeyPress"))
# disable hotkeys: else:
# disable hotkeys:     bind_axis("Left", "Right", 0)
# disable hotkeys:     bind_axis("Down", "Up", 1)
# disable hotkeys:     bind_axis("Next", "Prior", 2)
# disable hotkeys:     bind_axis("KP_Left", "KP_Right", 0)
# disable hotkeys:     bind_axis("KP_Down", "KP_Up", 1)
# disable hotkeys:     bind_axis("KP_Next", "KP_Prior", 2)
# disable hotkeys:     bind_axis("bracketleft", "bracketright", 3)
# disable hotkeys: 
# disable hotkeys: root_window.bind("<KeyPress-minus>", nomodifier(commands.jog_minus))
# disable hotkeys: root_window.bind("<KeyPress-equal>", nomodifier(commands.jog_plus))
# disable hotkeys: root_window.bind("<KeyRelease-minus>", commands.jog_stop)
# disable hotkeys: root_window.bind("<KeyRelease-equal>", commands.jog_stop)
