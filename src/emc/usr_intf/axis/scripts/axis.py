...
class _prompt_areyousure:
    ...
    def __init__(self, title, text):
        ...
        # disablet.bind("<Return>", lambda event: (self.ok.flash(), self.ok.invoke()))
        # disablet.bind("<KP_Enter>", lambda event: (self.ok.flash(), self.ok.invoke()))
        # disablet.bind("<space>", lambda event: (self.ok.flash(), self.ok.invoke()))
        # disablet.bind("<Escape>", lambda event: (self.cancel.flash(), self.cancel.invoke()))
...
class _prompt_float:
    ...
    def __init__(self, title, text, default, unit_str=''):
        ...
        t.wm_protocol("WM_DELETE_WINDOW", self.cancel.invoke)
        # disable hotkeys: t.bind("<Return>", lambda event: (self.ok.flash(), self.ok.invoke()))
        # disable hotkeys: t.bind("<KP_Enter>", lambda event: (self.ok.flash(), self.ok.invoke()))
        # disable hotkeys: t.bind("<Escape>", lambda event: (self.cancel.flash(), self.cancel.invoke()))
...
class _prompt_touchoff(_prompt_float):
    def __init__(self, title, text_pattern, default, defaultsystem):
        ...
        # disable hotkeys: for i in [1,2,3,4,5,6,7,8,9]:
        # disable hotkeys:     t.bind("<Alt-KeyPress-%s>" % i, lambda event, system=systems[i-1]: c.set(system))
        # disable hotkeys: if current_tool.id > 0:
        # disable hotkeys:     t.bind("<Alt-t>", lambda event: c.set(systems[9]))
        # disable hotkeys:     t.bind("<Alt-0>", lambda event: c.set(systems[9]))
...
# disable hotkeys: root_window.bind("<Escape>", commands.task_stop)
# disable hotkeys: root_window.bind("l", commands.toggle_override_limits)
# disable hotkeys: root_window.bind("o", commands.open_file)
# disable hotkeys: root_window.bind("s", commands.task_resume)
# disable hotkeys: root_window.bind("t", commands.task_step)
# disable hotkeys: root_window.bind("p", commands.task_pause)
# disable hotkeys: root_window.bind("v", commands.cycle_view)
# disable hotkeys: root_window.bind("<Alt-p>", "#nothing")
# disable hotkeys: root_window.bind("r", commands.task_run)
# disable hotkeys: root_window.bind("<Control-r>", commands.reload_file)
# disable hotkeys: root_window.bind("<Control-s>", commands.save_gcode)
# disable hotkeys: root_window.bind_class("all", "<Key-F1>", commands.estop_clicked)
# disable hotkeys: root_window.bind("<Key-F2>", commands.onoff_clicked)
# disable hotkeys: root_window.bind("<Key-F7>", commands.mist_toggle)
# disable hotkeys: root_window.bind("<Key-F8>", commands.flood_toggle)
# disable hotkeys: root_window.bind("<Key-F9>", commands.spindle_forward_toggle)
# disable hotkeys: root_window.bind("<Key-F10>", commands.spindle_backward_toggle)
# disable hotkeys: root_window.bind("<Key-F11>", commands.spindle_decrease)
# disable hotkeys: root_window.bind("<Key-F12>", commands.spindle_increase)
# disable hotkeys: root_window.bind("B", commands.brake_on)
# disable hotkeys: root_window.bind("b", commands.brake_off)
# disable hotkeys: root_window.bind("<Control-k>", commands.clear_live_plot)
# disable hotkeys: root_window.bind("x", lambda event: activate_axis(0))
# disable hotkeys: root_window.bind("y", lambda event: activate_axis(1))
# disable hotkeys: root_window.bind("z", lambda event: activate_axis(2))
# disable hotkeys: root_window.bind("a", lambda event: activate_axis(3))
# disable hotkeys: root_window.bind("`", lambda event: activate_axis_or_set_feedrate(0))
# disable hotkeys: root_window.bind("1", lambda event: activate_axis_or_set_feedrate(1))
# disable hotkeys: root_window.bind("2", lambda event: activate_axis_or_set_feedrate(2))
# disable hotkeys: root_window.bind("3", lambda event: activate_axis_or_set_feedrate(3))
# disable hotkeys: root_window.bind("4", lambda event: activate_axis_or_set_feedrate(4))
# disable hotkeys: root_window.bind("5", lambda event: activate_axis_or_set_feedrate(5))
# disable hotkeys: root_window.bind("6", lambda event: activate_axis_or_set_feedrate(6))
# disable hotkeys: root_window.bind("7", lambda event: activate_axis_or_set_feedrate(7))
# disable hotkeys: root_window.bind("8", lambda event: activate_axis_or_set_feedrate(8))
# disable hotkeys: root_window.bind("9", lambda event: set_feedrate(90))
# disable hotkeys: root_window.bind("0", lambda event: set_feedrate(100))
# disable hotkeys: root_window.bind("c", lambda event: jogspeed_continuous())
# disable hotkeys: root_window.bind("d", lambda event: widgets.rotate.invoke())
# disable hotkeys: root_window.bind("i", lambda event: jogspeed_incremental())
# disable hotkeys: root_window.bind("I", lambda event: jogspeed_incremental(-1))
# disable hotkeys: root_window.bind("!", "set metric [expr {!$metric}]; redraw")
# disable hotkeys: root_window.bind("@", commands.toggle_display_type)
# disable hotkeys: root_window.bind("#", commands.toggle_coord_type)
# disable hotkeys: root_window.bind("$", commands.toggle_joint_mode)
# disable hotkeys: 
# disable hotkeys: root_window.bind("<Home>", commands.home_axis)
# disable hotkeys: root_window.bind("<KP_Home>", kp_wrap(commands.home_axis, "KeyPress"))
# disable hotkeys: root_window.bind("<Control-Home>", commands.home_all_axes)
# disable hotkeys: root_window.bind("<Shift-Home>", commands.set_axis_offset)
# disable hotkeys: root_window.bind("<End>", commands.touch_off)
# disable hotkeys: root_window.bind("<Control-KP_Home>", kp_wrap(commands.home_all_axes, "KeyPress"))
# disable hotkeys: root_window.bind("<Shift-KP_Home>", kp_wrap(commands.set_axis_offset, "KeyPress"))
# disable hotkeys: root_window.bind("<KP_End>", kp_wrap(commands.touch_off, "KeyPress"))
# disable hotkeys: widgets.mdi_history.bind("<Configure>", "%W see end" )
# disable hotkeys: widgets.mdi_history.bind("<ButtonRelease-1>", commands.mdi_history_butt_1)
# disable hotkeys: widgets.mdi_history.bind("<Double-Button-1>", commands.mdi_history_double_butt_1)
# disable hotkeys: widgets.mdi_command.unbind("<Control-h>")
# disable hotkeys: widgets.mdi_command.bind("<Control-m>", commands.clear_mdi_history)
# disable hotkeys: widgets.mdi_command.bind("<Control-h>", commands.mdi_history_hist2clip)
# disable hotkeys: widgets.mdi_command.bind("<Control-Shift-H>", commands.mdi_history_clip2hist)
# disable hotkeys: widgets.mdi_command.bind("<Key-Return>", commands.send_mdi)
# disable hotkeys: widgets.mdi_command.bind("<Up>",  commands.mdi_up_cmd)
# disable hotkeys: widgets.mdi_command.bind("<Down>", commands.mdi_down_cmd)
# disable hotkeys: widgets.mdi_command.bind("<Key-KP_Enter>", commands.send_mdi)
# disable hotkeys: widgets.mdi_command.bind("<KP_Up>",  commands.mdi_up_cmd)
# disable hotkeys: widgets.mdi_command.bind("<KP_Down>", commands.mdi_down_cmd)
# disable hotkeys: widgets.mdi_command.bind("<KeyRelease-minus>", "break")
# disable hotkeys: widgets.mdi_command.bind("<KeyRelease-equal>", "break")
...
def bind_axis(a, b, d):
    # disable hotkeys: root_window.bind("<KeyPress-%s>" % a, kp_wrap(lambda e: jog_on(d, -get_jog_speed(d)), "KeyPress"))
    # disable hotkeys: root_window.bind("<KeyPress-%s>" % b, kp_wrap(lambda e: jog_on(d, get_jog_speed(d)), "KeyPress"))
    # disable hotkeys: root_window.bind("<Shift-KeyPress-%s>" % a, lambda e: jog_on(d, -get_max_jog_speed(d)))
    # disable hotkeys: root_window.bind("<Shift-KeyPress-%s>" % b, lambda e: jog_on(d, get_max_jog_speed(d)))
    # disable hotkeys: root_window.bind("<KeyRelease-%s>" % a, lambda e: jog_off(d))
    # disable hotkeys: root_window.bind("<KeyRelease-%s>" % b, lambda e: jog_off(d))
    print "" # do nothing 
# disable hotkeys: root_window.bind("<FocusOut>", lambda e: str(e.widget) == "." and jog_off_all())
...
# disable hotkey: root_window.bind("<KeyPress-KP_Begin>", kp_wrap(lambda e: None, "KeyPress"))
# disable hotkey: root_window.bind("<KeyPress-KP_Insert>", kp_wrap(lambda e: None, "KeyPress"))
# disable hotkey: 
# disable hotkey: if lathe:
# disable hotkey:     bind_axis("Left", "Right", 2)
# disable hotkey:     bind_axis("Up", "Down", 0)
# disable hotkey:     bind_axis("KP_Left", "KP_Right", 2)
# disable hotkey:     bind_axis("KP_Up", "KP_Down", 0)
# disable hotkey:     bind_axis("KP_4", "KP_6", 2)
# disable hotkey:     bind_axis("KP_8", "KP_2", 0)
# disable hotkey:     root_window.bind("<KeyPress-KP_Next>", kp_wrap(lambda e: None, "KeyPress"))
# disable hotkey:     root_window.bind("<KeyPress-KP_Prior>", kp_wrap(lambda e: None, "KeyPress"))
# disable hotkey: else:
# disable hotkey:     bind_axis("Left", "Right", 0)
# disable hotkey:     bind_axis("Down", "Up", 1)
# disable hotkey:     bind_axis("Next", "Prior", 2)
# disable hotkey:     bind_axis("KP_Left", "KP_Right", 0)
# disable hotkey:     bind_axis("KP_Down", "KP_Up", 1)
# disable hotkey:     bind_axis("KP_Next", "KP_Prior", 2)
# disable hotkey:     bind_axis("KP_4", "KP_6", 0)
# disable hotkey:     bind_axis("KP_2", "KP_8", 1)
# disable hotkey:     bind_axis("KP_3", "KP_9", 2)
# disable hotkey:     bind_axis("bracketleft", "bracketright", 3)

# disable hotkey: root_window.bind("<KeyPress-minus>", nomodifier(commands.jog_minus))
# disable hotkey: root_window.bind("<KeyPress-equal>", nomodifier(commands.jog_plus))
# disable hotkey: root_window.bind("<KeyRelease-minus>", commands.jog_stop)
...
t = widgets.text
# disable hotkeys: t.bind('<Button-3>', rClicker) #allow right-click to select start from line
...
# disable hotkeys: t.bind("<Button-1>", select_line)
# disable hotkeys: t.bind("<B1-Motion>", lambda e: "break")
# disable hotkeys: t.bind("<B1-Leave>", lambda e: "break")
# disable hotkeys: t.bind("<Button-4>", scroll_up)
# disable hotkeys: t.bind("<Button-5>", scroll_down)
t.configure(state="disabled")
...
# disable hotkeys: root_window.bind("<Control-space>", lambda event: notifications.clear())
# disable hotkeys: widgets.mdi_command.bind("<Control-space>", lambda event: notifications.clear())
...
if s.kinematics_type != emc.KINEMATICS_IDENTITY:
    ...
    widgets.menu_view.delete("end")
    widgets.menu_view.delete("end")
    # disable hotkeys: root_window.bind("$", "")


if lathe:
    root_window.after_idle(commands.set_view_y)
    # disable hotkeys: root_window.bind("v", commands.set_view_y)
    # disable hotkeys: root_window.bind("d", "")
...
# disable hotkeys: widgets.numbers_text.bind("<Configure>", commands.redraw_soon)
live_plotter.update()
