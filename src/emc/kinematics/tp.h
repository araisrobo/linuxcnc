...
extern int tpSetPSO(TP_STRUCT *tp, int enable, double pitch, int mode, int tick);
extern int tpSetLEAPFROG(TP_STRUCT *tp, int enable, double height);
