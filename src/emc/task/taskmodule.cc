...
#define VAL(X)  .value(#X, X)
	...
	.def_readwrite("axis", &EMC_AXIS_STAT::axis)
	// should be EMC_JOINT_STAT: .def_readwrite("units", &EMC_AXIS_STAT::units)
	// should be EMC_JOINT_STAT: .def_readwrite("backlash", &EMC_AXIS_STAT::backlash)
	// should be EMC_JOINT_STAT: .def_readwrite("minPositionLimit", &EMC_AXIS_STAT::minPositionLimit)
	// should be EMC_JOINT_STAT: .def_readwrite("maxPositionLimit" ,&EMC_AXIS_STAT::maxPositionLimit)
	// should be EMC_JOINT_STAT: .def_readwrite("maxFerror", &EMC_AXIS_STAT::maxFerror)
	// should be EMC_JOINT_STAT: .def_readwrite("minFerror", &EMC_AXIS_STAT::minFerror)
	// should be EMC_JOINT_STAT: .def_readwrite("ferrorCurrent", &EMC_AXIS_STAT::ferrorCurrent)
	// should be EMC_JOINT_STAT: .def_readwrite("ferrorHighMark", &EMC_AXIS_STAT::ferrorHighMark)
	// should be EMC_JOINT_STAT: .def_readwrite("output", &EMC_AXIS_STAT::output)
	// should be EMC_JOINT_STAT: .def_readwrite("input", &EMC_AXIS_STAT::input)
	// should be EMC_JOINT_STAT: .def_readwrite("velocity", &EMC_AXIS_STAT::velocity)
	// should be EMC_JOINT_STAT: .def_readwrite("inpos",  &EMC_AXIS_STAT::inpos)
	// should be EMC_JOINT_STAT: .def_readwrite("homing",  &EMC_AXIS_STAT::homing)
	// should be EMC_JOINT_STAT: .def_readwrite("homed",  &EMC_AXIS_STAT::homed)
	// should be EMC_JOINT_STAT: .def_readwrite("fault",  &EMC_AXIS_STAT::fault)
	// should be EMC_JOINT_STAT: .def_readwrite("enabled",  &EMC_AXIS_STAT::enabled)
	// should be EMC_JOINT_STAT: .def_readwrite("minSoftLimit",  &EMC_AXIS_STAT::minSoftLimit)
	// should be EMC_JOINT_STAT: .def_readwrite("maxSoftLimit",  &EMC_AXIS_STAT::maxSoftLimit)
	// should be EMC_JOINT_STAT: .def_readwrite("minHardLimit",  &EMC_AXIS_STAT::minHardLimit)
	// should be EMC_JOINT_STAT: .def_readwrite("maxHardLimit",  &EMC_AXIS_STAT::maxHardLimit)
	// should be EMC_JOINT_STAT: .def_readwrite("overrideLimits",  &EMC_AXIS_STAT::overrideLimits)
	;
